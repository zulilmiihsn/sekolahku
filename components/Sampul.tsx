...
export default function Hero() {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center min-h-[70vh] py-24 overflow-hidden">
      {/* Aurora Gradient */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.97 }}
        className="mt-10 px-8 py-3 rounded-full bg-primary text-white font-semibold shadow-lg hover:bg-accent transition-colors duration-200 relative inline-flex items-center"
